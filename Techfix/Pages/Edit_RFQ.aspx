<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_RFQ.aspx.cs" Inherits="TechfixSystem.Pages.Edit_RFQ" %>
...
<body>
    <form id="form1" runat="server" onsubmit="return validateForm();">
        <div class="container">
            <h1>Edit RFQ</h1>
            <asp:HiddenField ID="hfRFQID" runat="server" />
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtSpecifications" runat="server" TextMode="MultiLine" Rows="3" placeholder="Enter specifications"></asp:TextBox>
            ...
            <a href="Manage_RFQ.aspx" class="btn-back">Back </a>
        </div>
    </form>
</body>
</html>